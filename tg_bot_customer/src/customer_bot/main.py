...
from customer_bot.presentation.handlers import fallback_router, start_router
from customer_bot.presentation.middlewares import TelegramUserContextMiddleware
